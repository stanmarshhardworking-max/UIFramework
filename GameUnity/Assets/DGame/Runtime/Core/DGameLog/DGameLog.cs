...
namespace DGame
{
    public static class DGameLog
    {
        public interface ILogHelper
        {
            void Log(DGameLogLevel level, object msg);
        }

        private static ILogHelper m_logHelper = new DGameLogHelper();
        ...
        {
            m_logHelper?.Log(DGameLogLevel.Debug, msg);
        }
        ...
        public static void Info(object message)
        {
            ...
            m_logHelper.Log(DGameLogLevel.Info, message);
        }
        ...
        public static void Warning(object message)
        {
            ...
            m_logHelper.Log(DGameLogLevel.Warning, message);
        }
        ...
        public static void Error(object message)
        {
            ...
            m_logHelper.Log(DGameLogLevel.Error, message);
        }
        ...
        public static void Fatal(object message)
        {
            ...
            m_logHelper.Log(DGameLogLevel.Fatal, message);
        }
